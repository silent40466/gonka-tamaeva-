...
class CarSelection:
    def __init__(self):
        ...
        self.time_of_day_options = ["day", "sunset"]
    ...
    def draw(self):
        ...
        instr3 = font.render("Цифры 1-2 для выбора времени суток", True, BLACK)
...
class Game:
    ...
    def draw_sky(self):
        if self.time_of_day == "day":
            ...
            # Солнце
            pygame.draw.circle(screen, (255, 100, 0), (SCREEN_WIDTH // 2, 150), 50)
            # Облака
            for i in range(3):
                x = (SCREEN_WIDTH // 4) * i + 50
                y = 80 + (i * 20)
                pygame.draw.circle(screen, (255, 200, 200), (x, y), 20)
                pygame.draw.circle(screen, (255, 200, 200), (x+15, y-10), 15)
                pygame.draw.circle(screen, (255, 200, 200), (x+30, y), 20)
                pygame.draw.circle(screen, (255, 200, 200), (x+15, y+10), 15)
